<template>
  <form class="center" @submit.prevent="handleSignup">
    ...
    <div class="form-group">
      ...
      <input type="email" placeholder="me@sharpsub.com" v-model="email" required />
    </div>
    ...
    <!-- Toast Notifications -->
    <ToastNotification v-for="(toast, index) in toasts" :key="index" :type="toast.type" :title="toast.title"
      :description="toast.description" :timer="toast.timer" @close="removeToast(index)" />
  </form>
</template>
